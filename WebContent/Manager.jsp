...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/s/plugins/ui/jquery.colorpicker.js"></script>
...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="files"><a href="file_manager.html" title="" class="active"><span>File manager</span></a></li>
...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <!-- File manager -->
        <div class="widget">
            <div class="title"><img src="images/icons/dark/files.png" alt="" class="titleIcon" /><h6>File Manager</h6></div>
            <div id="fm"></div>
        </div>
